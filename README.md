...
<p align="center">
  ...
  <img alt="Gemini" src="https://img.shields.io/badge/Gemini-1.5%20Flash-8E75B2?logo=googlegemini&logoColor=white">
...
1. It checks that your Gemini key and webhook are configured.
2. It reads your local `git config user.name`.
3. It runs `git blame` on the line to get the author, the date, and the code.
4. It compares you against that author.
5. It prompts Gemini 1.5 Flash for an apology or a roast.
